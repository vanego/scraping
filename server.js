...
app.get("/scrape", function (req, res) {
    ...
    axios.get("https://www.wsj.com/").then(function (response) {
        ...
        $(".wsj-headline").each(function (i, element) {
            ...
            result.summary = $(this)
                .parent()
                .find(".wsj-summary span:first-child")
                .text();
...
// route to update article to be saved
app.put("/articles/:id", function (req, res) {
    db.Article.findByIdAndUpdate({ _id: req.params.id }, req.body)
        .then(function () {
            res.status(200).send();
        })
        .catch(function (err) {
...
app.get("/articles/all/saved", function (req, res) {
